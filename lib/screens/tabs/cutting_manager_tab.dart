...
class CuttingManagerTab extends StatefulWidget {
  final LoginResponse user;
  final ApiService api;

  const CuttingManagerTab({super.key, required this.user, required this.api});

  @override
  State<CuttingManagerTab> createState() => _CuttingManagerTabState();
}
...
class _CuttingManagerTabState extends State<CuttingManagerTab> {
  ...
  bool get _isCuttingMaster {
    final normalizedRole = widget.user.normalizedRole;
    if (normalizedRole == 'cutting_manager') {
      return true;
    }

    final rawRole = widget.user.role.toLowerCase();
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  Text(
                    'You are signed in as ${widget.user.role}. Use the menu to access your tools.',
